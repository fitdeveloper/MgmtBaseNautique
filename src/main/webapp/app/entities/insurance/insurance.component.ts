...
export class InsuranceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.insuranceService
        ...
        .subscribe(
          (res: HttpResponse<IInsurance[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInInsurances(): void {
    this.eventSubscriber = this.eventManager.subscribe('insuranceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IInsurance[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
