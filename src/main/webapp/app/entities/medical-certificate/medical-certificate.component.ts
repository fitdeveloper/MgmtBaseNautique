...
export class MedicalCertificateComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.medicalCertificateService
        ...
        .subscribe(
          (res: HttpResponse<IMedicalCertificate[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  ngOnInit(): void {
    ...
    this.registerChangeInMedicalCertificates();
  }
  ...
  registerChangeInMedicalCertificates(): void {
    this.eventSubscriber = this.eventManager.subscribe('medicalCertificateListModification', () => this.loadPage());
  }
