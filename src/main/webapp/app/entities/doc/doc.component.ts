...
export class DocComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.docService
        ...
        .subscribe(
          (res: HttpResponse<IDoc[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: IDoc[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
