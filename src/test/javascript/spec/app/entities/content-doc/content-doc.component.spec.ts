...
import { ContentDocComponent } from 'app/entities/content-doc/content-doc.component';
...
describe('Component Tests', () => {
  describe('ContentDoc Management Component', () => {
    let comp: ContentDocComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ContentDocComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contentDocs && comp.contentDocs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
