...
import { DealershipComponent } from 'app/entities/dealership/dealership.component';
...
describe('Component Tests', () => {
  describe('Dealership Management Component', () => {
    let comp: DealershipComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DealershipComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dealerships && comp.dealerships[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
