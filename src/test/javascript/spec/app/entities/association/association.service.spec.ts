...
describe('Service Tests', () => {
  describe('Association Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Association(0, 'AAAAAAA', 'AAAAAAA', 'image/png', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Association', () => {
        const returnedFromService = Object.assign(
          {
            numberAssociation: 'BBBBBB',
            nameAssociation: 'BBBBBB',
            imageAssociation: 'BBBBBB',
            descAssociation: 'BBBBBB',
          },
          elemDefault
        );
