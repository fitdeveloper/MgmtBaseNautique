...
import { MedicalCertificateComponent } from 'app/entities/medical-certificate/medical-certificate.component';
...
describe('Component Tests', () => {
  describe('MedicalCertificate Management Component', () => {
    let comp: MedicalCertificateComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MedicalCertificateComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new MedicalCertificate(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.medicalCertificates && comp.medicalCertificates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
