...
class MemberGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Member entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                "id":null
                , "numberMember":"SAMPLE_TEXT"
                , "typeMember":"MEMBER_INDIVIDUAL"
                , "cinMember":"SAMPLE_TEXT"
                , "firstnameMember":"SAMPLE_TEXT"
                , "lastnameMember":"SAMPLE_TEXT"
                , "emailMember":"SAMPLE_TEXT"
                , "numberPhoneMember":"SAMPLE_TEXT"
                , "dobMember":"2020-01-01T00:00:00.000Z"
                , "adressMember":"SAMPLE_TEXT"
                , "imageMember":null
                , "descMember":"SAMPLE_TEXT"
                }""")).asJson
            .check(status.is(201))
